...
@section('content')
    ...
    <div class="card mt-50">
        <div class="card-header btn-area d-flex justify-content-end">
            <button type="button" class="btn-1" data-bs-toggle="offcanvas" data-bs-target="#offcanvasSearch"
                aria-controls="offcanvasExample"><i class="fa-light fa-search me-1"></i>@lang('Filter') <span></span>
            </button>
        </div>
            ...
            <div class="cmn-table">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col">@lang('Profit')
                                    <i class="fa-sharp fa-thin fa-circle-info ms-1" data-bs-toggle="tooltip"
                                        data-bs-placement="top" aria-label="Per Return"
                ...
                @if (count($planInvestment ?? []) == 0)
                    <div class="row d-flex text-center justify-content-center">
                        <div class="col-4">
                            <img src="{{ asset('assets/admin/img/oc-error.svg') }}" id="no-data-image" class="no-data-image"
                                alt="" srcset="">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasSearch" aria-labelledby="offcanvasExampleLabel"
            ...
            <form action="{{ route('user.plan.investment') }}" method="GET">
                <div class="row g-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="date_range" class="form-control date flatpickr-input active"
                            readonly="readonly" placeholder="@lang('Select Dates')">
                    </div>
    ...
    @php
        $basic = App\Models\BasicControl::first();
        $timeZone = $basic->time_zone;
    @endphp
            ...
            function updateTime() {
                $('.next-payment').each(function() {
                    ...
                    if (nextPaymentTime) {
                        ...
                        let timeDifference = nextPaymentTime - serverTime;
